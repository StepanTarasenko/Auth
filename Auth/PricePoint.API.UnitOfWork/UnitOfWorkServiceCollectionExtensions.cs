...
namespace PricePoint.API.UnitOfWork
{
    ...
    public static class UnitOfWorkServiceCollectionExtensions
    {
        ...
        /// This method only support one db context, if been called more than once, will throw exception.
        /// </remarks>
        public static IServiceCollection AddUnitOfWork<TContext, TUser, TRole>(this IServiceCollection services)
            where TContext : DbContext 
            where TUser : IdentityUser<Guid>
            where TRole : IdentityRole<Guid>
        {
            services.AddScoped<IRepositoryFactory, UnitOfWork<TContext, TUser, TRole>>();
            // Following has a issue: IUnitOfWork cannot support multiple dbContext/database, 
            // that means cannot call AddUnitOfWork<TContext> multiple times.
            // Solution: check IUnitOfWork whether or null
            services.AddScoped<IUnitOfWork<TUser, TRole>, UnitOfWork<TContext, TUser, TRole>>();
            services.AddScoped<IUnitOfWork<TContext, TUser, TRole>, UnitOfWork<TContext, TUser, TRole>>();
        ...
        //    where TContext1 : ApplicationDbContext
        //    where TContext2 : ApplicationDbContext
        //{
        ...
        //    where TContext1 : ApplicationDbContext
        //    where TContext2 : ApplicationDbContext
        //    where TContext3 : ApplicationDbContext
        //{
        //    services.AddScoped<IUnitOfWork<TContext1>, UnitOfWork<TContext1>>();
        //    services.AddScoped<IUnitOfWork<TContext2>, UnitOfWork<TContext2>>();
        ...
        //    where TContext2 : ApplicationDbContext
        //    where TContext3 : ApplicationDbContext
        //    where TContext4 : ApplicationDbContext
        //{
        //    services.AddScoped<IUnitOfWork<TContext1>, UnitOfWork<TContext1>>();
        //    services.AddScoped<IUnitOfWork<TContext2>, UnitOfWork<TContext2>>();
        //    services.AddScoped<IUnitOfWork<TContext3>, UnitOfWork<TContext3>>();
